...
import { RotateCcw, Zap, Target, Shield, TrendingUp, Timer } from 'lucide-react';
...
export default function SummaryPanel({ calculation, onReset, onBestAmmo }: SummaryPanelProps) {
  if (!calculation) {
    return (
        ...
        <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/30 rounded-2xl p-6 mb-4">
          ...
          <div className="grid grid-cols-6 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-red-400">{calculation.finalDamage}</div>
              <div className="text-xs text-zinc-400">Урон</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-400">{calculation.ttk.toFixed(1)}s</div>
              <div className="text-xs text-zinc-400">TTK</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-400">{calculation.shotsToKill}</div>
              <div className="text-xs text-zinc-400">Выстрелов</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-400">{calculation.penetrationChance}%</div>
              <div className="text-xs text-zinc-400">Пробитие</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">{calculation.headshotShots}</div>
              <div className="text-xs text-zinc-400">В голову</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-400">{calculation.chestShots}</div>
              <div className="text-xs text-zinc-400">В грудь</div>
            </div>
          </div>
        </div>
