...
export default function BunkersPage() {
  ...
  return (
    <main>
      <PageHeader
        title="Бункеры"
        description="Обновленная вкладка бункеров: только подтвержденные точки с твоих скринов, обычные и заброшенные бункеры, а также карты уровней для заброшенных и схемы для обычных бункеров, которые ты прислал."
      />
