...
export default function BunkersPage() {
  ...
  return (
    <main>
      <PageHeader
        title="Бункеры"
        description="Обновленная вкладка бункеров: обычные и заброшенные бункеры, а также карты уровней для заброшенных и схемы для обычных бункеров, которые ты прислал."
      />
