...
export const mapMarkers: MapMarker[] = [
  ...
  trader("C2", 51.0, 22.0, "Торговец C2", "островная safe zone на озере в секторе C2; координата подправлена по твоим скринам"),
  trader("Z2", 43.8, 84.4, "Торговец Z2", "северная safe zone в секторе Z2; координата подправлена по твоим скринам"),
  trader("Z0", 80.7, 75.8, "Торговец Z0", "островная safe zone в южной части карты; координата подправлена по твоим скринам"),
];
