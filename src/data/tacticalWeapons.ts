  ...
  },
  {
    ...
    ammoTypes: [
      ...
      },
      {
        ...
        type: 'ap',
        color: '#EF4444',
        description: 'Бронебойные пистолетные патроны',
      ...
      },
      {
        ...
        type: 'hp',
        color: '#F59E0B',
        description: 'Расширяющиеся пистолетные патроны',
